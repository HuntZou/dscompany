            ...
            <BrowserRouter>
                <Layout>
                    <Layout.Sider style={{background:'#00000000'}}>
                        <Menu  defaultSelectedKeys={['buildingMaterial']}>
                            <Menu.Item key="buildingMaterial"><Link to="/wholesale">基础建材</Link></Menu.Item>
                            <Menu.Item key="decorateMaterial"><Link to="/wholesale/decorateMaterial">装饰材料</Link></Menu.Item>
                        </Menu>
                    </Layout.Sider>

                    <Layout.Content>
                        <Switch>
                            <Route exact={true} path="/wholesale" component={BuildingMaterial}/>
                            <Route exact={true} path="/wholesale/decorateMaterial" component={DecorateMaterial}/>
                        </Switch>
                    </Layout.Content>
                </Layout>
            </BrowserRouter>
...
class DecorateMaterial extends React.Component {
    render() {
        return (
            <h3>
